  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40 z-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4 max-md:mt-10 bg-white/20 px-4 py-2 rounded-full shadow-md w-fit border border-gray-200">
            <img
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10 z-10">
        <SignIn 
          routing="hash" 
          signUpUrl="/sign-up" // Correctly routes to your new SignUp.jsx
          appearance={{
            layout: {
