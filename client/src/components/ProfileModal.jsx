...
function ProfileModal({ setShowEdit }) {
    ...
    const maxLength = 500;
    const remainingChars = maxLength - (editForm.bio?.length || 0);
                    ...
                    <form className='space-y-4' onSubmit={e => toast.promise(
                        ...
                        <div className='relative'>
                            <div className='flex justify-between items-center mb-1'>
                                ...
                                <span className={`text-xs font-medium ${remainingChars <= 50 ? 'text-red-500' : 'text-gray-400'}`}>
                            ...
                            <textarea
                                rows={3}
                                maxLength={maxLength}
                                className={`w-full p-3 border rounded-lg focus:ring-2 outline-none transition-colors ${remainingChars <= 50 ? 'border-red-300 focus:ring-red-100' : 'border-gray-200 focus:ring-indigo-500'}`}
